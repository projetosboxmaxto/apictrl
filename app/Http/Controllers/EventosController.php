  ...
  //46500
        ...
        public function index3(Request $request)
	{
            ...
            $sql = " select pr.nome as programa, em.nome as emissora,
				     	...
				     	(TIME_TO_SEC(pr.hora_inicio) - TIME_TO_SEC(pr.transcricao_tempo_extra_inicio)) <=".$hora_seg." and 
					(TIME_TO_SEC(pr.hora_fim) - TIME_TO_SEC(pr.transcricao_tempo_extra_fim)) >= ".$hora_seg." and pr.transcricao_dias like  '%".$dia_semana."%' order by prioridade_int asc  ";
