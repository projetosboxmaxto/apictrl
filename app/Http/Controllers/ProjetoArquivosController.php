...
class ProjetoArquivosController extends Controller {
	      ...
	      $filtro = "";
              ...
              if ( $request->input( "filtro")  != ""){
                ...
                $sql = "select p.*, '' as blnk, '' as user_link, '' as data "
                        . " from projeto_arquivos p where 1 = 1 ". $filtro . " order by ".$order. " ".$order_type ;
                $itens = DB::select($sql);
	...
	/*
	            Route::get('/api/projeto_arquivos', 'ProjetoArquivosController@index');
                Route::get('/api/projeto_arquivos/{id}', 'ProjetoArquivosController@show');
                Route::put('/api/projeto_arquivos/{id}', 'ProjetoArquivosController@update');
                Route::post('/api/projeto_arquivos', 'ProjetoArquivosController@create');
                Route::delete('/api/projeto_arquivos/{id}', 'ProjetoArquivosController@destroy');
	...
	public function grid(Request $request){
		         ...
		         $filtro = ""; $str_filt = "";
                         ...
                         $sql = " select count(*) as res from projeto_arquivos where 1 = 1 ".$filtro ;
                         ...
                         $sql = "select p.* from projeto_arquivos p where 1 = 1 ". $filtro . " order by ".$order. " ".$order_type .
