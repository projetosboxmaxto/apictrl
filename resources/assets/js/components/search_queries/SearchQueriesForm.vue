...
<section class="col-lg-12">
	<section class="col-lg-9" style="padding-left: 0px; margin-left: 0px">
      <h1 style="padding-left: 0px; margin-left: 0px">search_queries
...
<div class="box-body">
 ...
 <div class="form-group">  
			  ...
			  <label for="f_querie" >Deve Conter</label>
 ...
 <div class="form-group">  
								  ...
								  <label for="f_id_praca">id_praca</label>
								   <input class="form-control" name="f_id_praca" 
									 id="f_id_praca" v-model="id_praca"
							  type="text" placeholder="id_praca" > {{exibe_error('id_praca')}}
...
import SearchQueriesForm from './components/search_queries/SearchQueriesForm'
       ...
       data: function() {
        ...
        mounted() {
                ...
                let self = this;
                          ...
                          var url =  "search_queries/" + this.id_load; console.log("monted post url: " + url );
                          var method = "get";
        ...
        self.id_praca = item.id_praca;   
        	...
        	salvar (tipo ){
                ...
                let self = this;
                var url =  "search_queries"; console.log("url: " + window.URL_API + url );
                var method = "POST";
              ...
              var fn_return = function (retorno){
            	  ...
            	  self.message_text = "search_queries salvo com sucesso!";
        	...
        	excluir(){
        		...
        		obj_api.call_delete("search_queries", this.id, fn_return);
        	}
         }
